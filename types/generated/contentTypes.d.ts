...
export interface ApiBidBid extends Struct.CollectionTypeSchema {
  collectionName: 'bids';
  info: {
    description: 'Collection type for vendor bids on RFQs';
    displayName: 'Bid';
    pluralName: 'bids';
    singularName: 'bid';
  };
  ...
  attributes: {
    ...
    isWinning: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    price: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    proposal: Schema.Attribute.RichText & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    rfq: Schema.Attribute.Relation<'manyToOne', 'api::rfq.rfq'>;
    status: Schema.Attribute.Enumeration<
      ['submitted', 'under_review', 'accepted', 'rejected', 'awarded']
    > &
...
export interface ApiBuyerBuyer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Collection type for buyers in the RFQ platform';
    displayName: 'Buyer';
    pluralName: 'buyers';
    singularName: 'buyer';
  };
  ...
  attributes: {
    additionalNumbers: Schema.Attribute.JSON;
    address: Schema.Attribute.Text;
    city: Schema.Attribute.String;
    commercialRegistration: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::buyer.buyer'> &
      Schema.Attribute.Private;
    nationalAddress: Schema.Attribute.String;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    rfqs: Schema.Attribute.Relation<'oneToMany', 'api::rfq.rfq'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDisputeDispute extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Dispute resolution system for RFQs and bids';
    displayName: 'Dispute';
    pluralName: 'disputes';
  ...
  attributes: {
    ...
    assignedAdmin: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    bid: Schema.Attribute.Relation<'manyToOne', 'api::bid.bid'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    disputeType: Schema.Attribute.Enumeration<
      [
        'payment',
        'quality',
        'delivery',
    ...
    > &
      Schema.Attribute.Required;
    estimatedResolutionTime: Schema.Attribute.Integer;
    evidence: Schema.Attribute.Media<'files' | 'images', true>;
    involvedParties: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    resolutionDate: Schema.Attribute.DateTime;
    rfq: Schema.Attribute.Relation<'manyToOne', 'api::rfq.rfq'>;
    status: Schema.Attribute.Enumeration<
      [
        'submitted',
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Internal communication system for buyers and vendors';
    displayName: 'Message';
    pluralName: 'messages';
  ...
  attributes: {
    ...
    messageType: Schema.Attribute.Enumeration<
      ['inquiry', 'clarification', 'negotiation', 'update', 'system']
    > &
    ...
    recipient: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    replies: Schema.Attribute.Relation<'oneToMany', 'api::message.message'>;
    rfq: Schema.Attribute.Relation<'manyToOne', 'api::rfq.rfq'>;
...
export interface ApiRfqRfq extends Struct.CollectionTypeSchema {
  collectionName: 'rfqs';
  info: {
    description: 'Collection type for RFQs in the platform';
    displayName: 'RFQ (Request for Quotation)';
    pluralName: 'rfqs';
    singularName: 'rfq';
  };
  options: {
  ...
  attributes: {
    attachments: Schema.Attribute.Media<'files', true>;
    awardedBid: Schema.Attribute.Relation<'oneToOne', 'api::bid.bid'>;
...
export interface ApiVendorVendor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Collection type for vendors in the RFQ platform';
    displayName: 'Vendor';
    pluralName: 'vendors';
    singularName: 'vendor';
  };
